...
import { fetchBot, fetchBotUser, fetchBotConversationMessages, uploadBotFile } from '../../../../../botsApi';
import { sendUserMessage } from '../../../../../botUserMessagesApi';
  ...
  const load = useCallback(async () => {
    try {
      const [b, u, m] = await Promise.all([
        ...
        // PHASE 17 — read via the conversation route so opening this
        // thread from the inbox also marks the conversation read.
        fetchBotConversationMessages(id, userId),
      ]);
      setBot(b);
      setUser(u);
