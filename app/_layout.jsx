...
function RootLayoutNav() {
  ...
  const { loaded, accounts, addingAccount, endAddAccount } = useAccounts();
  ...
  return (
    <NotificationsProvider>
      ...
      >
        ...
        <Stack.Screen name="create-bot" options={{ title: 'New bot', presentation: 'modal' }} />
        <Stack.Screen name="conversation/[id]" options={{ title: '' }} />
        <Stack.Screen name="contact/[id]" options={{ headerShown: false }} />
        <Stack.Screen name="bot/[id]/index" options={{ headerShown: false }} />
        <Stack.Screen name="bot/[id]/activity" options={{ title: 'Activity' }} />
        <Stack.Screen name="bot/[id]/edit" options={{ title: 'Edit bot', presentation: 'modal' }} />
        <Stack.Screen name="bot/[id]/settings" options={{ title: 'Settings' }} />
        ...
        <Stack.Screen name="bot/[id]/analytics" options={{ title: 'Analytics' }} />
        ...
        <Stack.Screen name="settings-active-sessions" options={{ title: 'Active Sessions' }} />
        <Stack.Screen name="settings-devices" options={{ title: 'Devices' }} />
        <Stack.Screen name="settings-login-activity" options={{ title: 'Login Activity' }} />
        <Stack.Screen name="settings-developer" options={{ title: 'Developer' }} />
        <Stack.Screen name="settings-api-keys" options={{ title: 'API Keys' }} />
        <Stack.Screen name="settings-api-key-create" options={{ title: 'New API Key', presentation: 'modal' }} />
        <Stack.Screen name="settings-bot-tokens" options={{ title: 'Bot Tokens' }} />
        <Stack.Screen name="settings-webhooks" options={{ title: 'Webhooks' }} />
        <Stack.Screen name="settings-webhook-edit" options={{ title: 'Webhook', presentation: 'modal' }} />
        <Stack.Screen name="settings-api-docs" options={{ title: 'API Documentation' }} />
        <Stack.Screen name="settings-ip-allowlist" options={{ title: 'IP Allowlist' }} />
        <Stack.Screen name="settings-security-alerts" options={{ title: 'Security Alerts' }} />
        <Stack.Screen name="settings-passcode" options={{ title: 'Passcode Lock' }} />
        <Stack.Screen name="settings-two-step" options={{ title: 'Two-Step Verification' }} />
        <Stack.Screen name="settings-about" options={{ title: 'About' }} />
        <Stack.Screen name="settings-licenses" options={{ title: 'Licenses' }} />
        <Stack.Screen name="settings-help" options={{ title: 'Help' }} />
        <Stack.Screen name="server/create" options={{ title: 'New server', presentation: 'modal' }} />
        <Stack.Screen name="server/[id]/index" options={{ headerShown: false }} />
        <Stack.Screen name="server/[id]/channels" options={{ title: 'Channels' }} />
        <Stack.Screen name="server/[id]/create-channel" options={{ title: 'New channel', presentation: 'modal' }} />
        <Stack.Screen name="server/[id]/channel/[channelId]" options={{ headerShown: false }} />
        <Stack.Screen name="server/[id]/members" options={{ title: 'Members' }} />
        <Stack.Screen name="server/[id]/bots" options={{ title: 'Bots' }} />
        <Stack.Screen name="server/[id]/add-bot" options={{ title: 'Add bot', presentation: 'modal' }} />
        <Stack.Screen name="server/[id]/files" options={{ title: 'Files' }} />
        <Stack.Screen name="server/[id]/settings" options={{ title: 'Settings' }} />
