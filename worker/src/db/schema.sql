-- BotManager D1 Schema
-- Run: wrangler d1 execute botmanager-db --file=src/db/schema.sql
-- Remote: wrangler d1 execute botmanager-db --remote --file=src/db/schema.sql
